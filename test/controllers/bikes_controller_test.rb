...
class BikesControllerTest < ActionController::TestCase
  ...
  test "should create bike" do
    assert_difference('Bike.count') do
      post :create, bike: { description: @bike.description, image_url: @bike.image_url, manufacturer_id: @bike.manufacturer_id, name: @bike.name }
    end
  ...
  test "should update bike" do
    patch :update, id: @bike, bike: { description: @bike.description, image_url: @bike.image_url, manufacturer_id: @bike.manufacturer_id, name: @bike.name }
    assert_redirected_to bike_path(assigns(:bike))
  end
